      ...
      <main className="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div className="w-full max-w-2xl bg-white/95 text-black rounded-xl shadow-2xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Take turns adding words or short phrases to build a sentence based
            on the image.
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3 justify-center mt-4">
              <button
                onClick={goToGame}
                className="py-3 px-6 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700"
              >
                Join Game
              </button>
              <button
                onClick={() => router.push("/student/playground")}
                className="py-3 px-6 bg-purple-100 text-purple-700 rounded-lg border border-purple-300"
              >
                Back
              </button>
            </div>
