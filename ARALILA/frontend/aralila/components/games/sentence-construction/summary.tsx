...
export const SentenceConstructionSummary = ({
  score,
  results,
}: SentenceConstructionSummaryProps) => {
  ...
  return (
    <>
      <motion.div
        className="relative z-10 bg-white border border-slate-200 rounded-3xl p-8 sm:p-12 max-w-4xl w-full text-center shadow-2xl"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="md:col-span-1">
            <Leaderboard
              gameId={6}
              gameType="sentence-construction"
              areaId={4}
              difficulty={1}
              limit={10}
            />
          ...
          <div className="space-y-4">
            {incorrectResults.map((result, index) => (
              ...
              >
                ...
                <p className="text-lg p-2 rounded-md bg-red-100 text-red-800 mb-2">
                ...
                <p className="text-lg p-2 rounded-md bg-green-100 text-green-800 mb-2">
                  &quot;{result.question.correctSentence}&quot;
                </p>
