...
import { Trophy, Star, Zap, RotateCcw, Check, X } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start max-h-[80vh] overflow-y-auto scrollbar-hide">
        ...
        >
          ...
          <div>
            ...
            {showReview && (
              <div className="mt-4 bg-gray-50 border border-gray-200 rounded-xl p-4 max-h-64 overflow-y-auto scrollbar-yellow">
