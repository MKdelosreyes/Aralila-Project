...
const cards = [
  { id: 1, title: "Spell Mo 'Yan", image: "/images/art/game-art-1.png", category: "Spelling", description: "Subukan ang bilis mo sa paghahanap at pagtatama ng maling baybay ng mga salita sa pangungusap." },
  { id: 2, title: "Puntuhang Puntos", image: "/images/art/game-art-2.png", category: "Punctuation", description: "Ilagay ang tamang bantas (tuldok o kuwit) sa mga pangungusap para makakuha ng puntos." },
  { id: 3, title: "Salita't Uri", image: "/images/art/game-art-3.png", category: "Parts of Speech", description: "Kilalanin at uriin ang mga salita (pangngalan, pandiwa, at iba pa.) sa loob ng pangungusap." },
  { id: 4, title: "Salitang Konektado", image: "/images/art/game-art-4.png", category: "Word Association", description: "Hulaan ang salita na nagkokonekta sa mga ibinigay na pahiwatig o larawan." },
  { id: 5, title: "Tugmahan Tayo", image: "/images/art/game-art-5.png", category: "Word Matching", description: "Itugma ang mga salita sa kanilang kahulugan o tamang gamit sa mga pangungusap." },
  { id: 6, title: "Gramatika Galore", image: "/images/art/game-art-6.png", category: "Grammar", description: "Hanapin at itama ang mga mali sa mga pangungusap para maging perpekto ang gramatika." },
  { id: 7, title: "Ayusin ang Pangungusap", image: "/images/art/game-art-7.png", category: "Sentence Structure", description: "Ayusin ang mga nagulong salita para makabuo ng tama at buong pangungusap." },
  { id: 8, title: "Kwento ng mga Emoji", image: "/images/art/game-art-8.png", category: "Comprehension", description: "Hulaan kung anong pangungusap ang ibig sabihin ng mga emoji, at buuin ito sa Filipino!" },
];
